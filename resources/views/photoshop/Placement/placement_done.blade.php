  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"   id="placementdonetable">
  							<thead>
  								<tr class="bg-primary">
								  <th>Sr No</th>
  									<th>Sku</th>
...
<!-- /.main-wrappper -->
<input type="hidden" id="placementdoneAjax" value="<?=URL::to('Photoshop/placement/done_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#placementdonetable').DataTable({
  ...
  "order": [[ 0, "desc" ]],
  "deferLoading": <?=count($done_list)?>,
  "processing": true,
  "serverSide": true,
  "searching": false,
  "serverMethod": "post",
  "ajax":{
    "url": $("#placementdoneAjax").val(),
