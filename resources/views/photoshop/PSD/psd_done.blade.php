  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"  id="psdreworktable">
  							<thead>
  								<tr class="bg-primary">
								  	<th>Sr No</th>
  									<th>Sku</th>
...
<!-- /.main-wrappper -->
<input type="hidden" id="psddonelistAjax" value="<?=URL::to('Photoshop/PSD/done_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#psdreworktable').DataTable({
