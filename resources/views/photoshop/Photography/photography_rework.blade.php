  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
                    ...
                    <th>Status</th>
						   ...
						   <td>Rework</td>
							   <td>
									   <select name="status" id="status" onchange="reworktodone(this.value)" class="form-control" style="height:20px;width:150px;float: left;">
...
<!-- /.main-wrappper -->
<input type="hidden" id="photographyreworklistAjax" value="<?=URL::to('Photoshop/Photography/rework_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#photographyreworktable').DataTable({
  ...
  "ajax":{
    "url": $("#photographyreworklistAjax").val(),
