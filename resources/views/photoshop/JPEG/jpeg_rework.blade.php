...
<main class="main-wrapper clearfix">
  ...
  <div class="row page-title clearfix">
    {{ Breadcrumbs::render('jpeg.rework') }}
      <!-- /.page-title-right -->
  </div>
  <!-- /.page-title -->
  <!-- =================================== -->
...
@endif
                            <div class="widget-body clearfix">
                                <h5 class="box-title">Total Rework Filter</h5>
                                <div class="tabs">
			...
			<div class="col-md-12 widget-holder content-area">
				<div class="widget-bg">
					<div class="widget-heading clearfix">
						<h5 class="border-b-light-1 pb-1 mb-2 mt-0 w-100">Rework Filter</h5>
  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"   id="jpegreworkdepartment">
  							<thead>
  								<tr class="bg-primary">
								  <th>Sr No</th>
  									<th>Sku</th>
...
<!-- /.main-wrappper -->
<input type="hidden" id="jpegreworklistAjax" value="<?=URL::to('Photoshop/JPEG/rework_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#jpegreworkdepartment').DataTable({
...
if(status !="0"){
  swal({
              ...
              if(data.value){
               ...
               $.ajax({
          url: "<?=URL::to('Photoshop/JPEG/rework');?>",
          type:"POST",
          data:{
            "_token": "{{ csrf_token() }}",
            status:status,
