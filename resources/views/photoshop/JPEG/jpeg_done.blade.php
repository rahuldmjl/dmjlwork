  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"  id="jpegdonetable">
							<thead>
								<tr class="bg-primary">
								<th>Sr No</th>
									<th>Sku</th>
...
<!-- /.main-wrappper -->
<input type="hidden" id="jpegdonelistAjax" value="<?=URL::to('Photoshop/JPEG/done_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#jpegdonetable').DataTable({
...
if(status !="0"){
  swal({
              ...
              if(data.value){
               ...
               $.ajax({
          url: "<?=URL::to('Photoshop/JPEG/done');?>",
          type:"POST",
          data:{
            "_token": "{{ csrf_token() }}",
            status:status,
