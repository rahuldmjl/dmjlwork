...
@endif
                            <div class="widget-body clearfix">
                                <h5 class="box-title">Total JPEG Filter</h5>
                                <div class="tabs">
			...
			<div class="col-md-12 widget-holder content-area">
				<div class="widget-bg">
					<div class="widget-heading clearfix">
						<h5 class="border-b-light-1 pb-1 mb-2 mt-0 w-100">Jpeg Filter</h5>
  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"  id="jpegdepartment">
							<thead>
								<tr class="bg-primary">
									<th>Sr No</th>
									<th>Sku</th>
							...
							<td>{{$item->name}}</td>
								...
								<td> <select name="status"  onchange="pendingtodone(this.value)" class="form-control" style="height:20px;width:150px;float: left;">
...
<!-- /.main-wrappper -->
<input type="hidden" id="jpeglistAjax" value="<?=URL::to('Photoshop/JPEG/pending_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#jpegdepartment').DataTable({
...
if(status !="2"){
  swal({
              ...
              if(data.value){
               ...
               $.ajax({
          url: "<?=URL::to('Photoshop/JPEG/pending');?>",
          type:"POST",
          data:{
            "_token": "{{ csrf_token() }}",
            status:status,
