  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"   id="editingreworkdatatable">
  							<thead>
  								<tr class="bg-primary">
								  <th>Sr No</th>
  									<th>Sku</th>
...
<!-- /.main-wrappper -->
<input type="hidden" id="editingreworklistAjax" value="<?=URL::to('Photoshop/Editing/rework_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#editingreworkdatatable').DataTable({
