  			...
  			<div class="col-md-12 widget-holder content-area">
  				<div class="widget-bg">
  					...
  					<div class="widget-body clearfix dataTable-length-top-0">
	                    ...
	                    <table class="table table-striped table-center word-break mt-0"   id="editingdonedatatable">
							<thead>
								<tr class="bg-primary">
									<th>Sr No</th>
									<th>Sku</th>
						...
						$i=1;
						  ?>
							...
							<td>Done</td>
								<td>
									<select name="status" onchange="donetorework(this.value)" class="form-control" style="height:20px;width:150px;float: left;">
...
<!-- /.main-wrappper -->
<input type="hidden" id="editingdonelistAjax" value="<?=URL::to('Photoshop/Editing/done_ajax_list');?>">
...
$.ajaxSetup({
	...
	var table = $('#editingdonedatatable').DataTable({
